...
| Modeler **Optional Role** |<img src="https://giphy.com/embed/xThtapzvqTGViWhwuA" width="200"  /> |The Modeler must find a model or visualization that captures at least one of the topics discussed in the chapter.  Bonus points if the model is coded in a reproducible RMarkDown document|
...
## Schedule
Updated 1/21/2024 and still subject to change
