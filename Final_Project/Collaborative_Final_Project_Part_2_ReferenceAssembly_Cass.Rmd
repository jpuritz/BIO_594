...
```
Output: I am not sure how to fix this. I feel like the order of the 64 and PE in the above command is wrong but that would be so many processors! My idea is "RefMapOpt.sh 4 8 4 8 0.9 PE 64" but 64 processors is way too many.
```{bash EVAL = FALSE}
...
Please make sure to choose assembly type.
```
