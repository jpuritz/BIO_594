...
## SNP Filtering (VCFtools, vcflib, rad_haplotyper) (Willow) - monday, done mid-day on tuesday 

# Population-level Analyses

## Detecting Selection Via Outlier Detection Programs (Flow and Michelle) - sunday 
      * RDA 
      * Bayenv2
      * PCAadapt
      * Outflank

## Detecting Population Structure (Brittany and Angela) - due may 9th 
      * Pairwise *F~ST~*
